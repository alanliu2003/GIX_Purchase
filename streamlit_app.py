...
st.markdown(
    "Use the sidebar for **Student** (submit purchases) or **Coordinator** (review and set status). "
    "Data is stored in **MySQL** — configure `MYSQL_*` in `.env` and run `python init_db.py` once.\n\n"
